...
public class CountriesKeyQuery extends Heatmap implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		countrieskeyLabel2.add(RootPanel.get("contentContainer"));
	...
	/**	if(!((RootPanel.get("ngramCountriesKey")).getElement().getInnerText().isEmpty()))
		{
			y=1;
			ngram=(RootPanel.get("ngramCountriesKey").getElement().getInnerText());			
		}*/
