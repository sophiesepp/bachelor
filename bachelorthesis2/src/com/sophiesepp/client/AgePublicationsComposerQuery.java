...
public class AgePublicationsComposerQuery extends D3 implements EntryPoint{
	...
	public void onModuleLoad() {
		...
		agepublicationscomposerLabel3.add(RootPanel.get("contentContainer"));
	...
	public static String buildQueryAgePublicationsComposer(){
		...
		/**if(!((RootPanel.get("ngramAgePublicationsComposer")).getElement().getInnerText().isEmpty()));
		{
			z=1;
			key= (RootPanel.get("ngramAgePublicationsComposer").getElement().getInnerText());			
		}*/
