...
public class AgeKeyQuery  extends Heatmap implements EntryPoint{
	...
	public void onModuleLoad() {
		...
		agekeyLabel3.add(RootPanel.get("contentContainer"));
	...
	public static String buildQueryAgeKey(){
		...
		/**if( !( RootPanel.get("ngramAgeKey").getElement().getInnerText().isEmpty() )  )
		{
			z=1;
			ngram= (RootPanel.get("ngramTimeAge").getElement().getInnerText());			
		}*/
