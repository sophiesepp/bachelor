...
public class KeyPercentQuery extends D3 implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		keypercentLabel3.add(RootPanel.get("contentContainer"));
	...
	public static String buildQueryKeyPercent(){
		...
		/**if(!((RootPanel.get("ngramKeyPercent")).getElement().getInnerText().isEmpty()))
		{
			y=1;
			ngram= (RootPanel.get("ngramKeyPercent").getElement().getInnerText());			
		}*/
