...
public class TimeCountryQuery extends Heatmap implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		timecountryLabel3.add(RootPanel.get("contentContainer"));
	...
	public static String buildQueryTimeCountry(){
		...
		/**if(  !(   RootPanel.get("ngramTimeCountry").getElement().getInnerText().isEmpty()  )  )
		{
			x=1;
			ngram= (RootPanel.get("ngramAgePublicationsComposer").getElement().getInnerText());			
		}*/
