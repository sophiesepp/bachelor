...
public class TimePublicationsQuery extends D3 implements EntryPoint{
	...
	public void onModuleLoad() {
		...
		ngramTimePublications.addStyleName("textfield1");
		...
		timepublicationsLabel3.add(timepublicationscountryLabel);
		timepublicationsLabel3.add(countryTimePublications);
		timepublicationsLabel4.add(RootPanel.get("contentContainer"));
	...
	public static String buildQueryTimePublications(){
		...
		/**if(!((RootPanel.get("ngramTimePublications")).getElement().getInnerText().isEmpty()))
		{
			n=1;
			ngram= (RootPanel.get("ngramTimePublications").getElement().getInnerText());			
		}*/
