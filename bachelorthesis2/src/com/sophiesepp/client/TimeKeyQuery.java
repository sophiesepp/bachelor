...
public class TimeKeyQuery extends Heatmap implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		timekeyLabel3.add(RootPanel.get("contentContainer"));
	...
	public static String buildQueryTimeKey(){
		...
		/**if(!((RootPanel.get("ngramTimeKey")).getElement().getInnerText()).isEmpty())
		{
			z=1;
			ngram= (RootPanel.get("ngramTimeKey").getElement().getInnerText());			
		}*/
