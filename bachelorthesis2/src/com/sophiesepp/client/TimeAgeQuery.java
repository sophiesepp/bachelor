...
public class TimeAgeQuery extends Heatmap implements EntryPoint   {
	...
	public void onModuleLoad() {
		...
		timeageLabel3.add(RootPanel.get("contentContainer"));
	...
	public static String buildQueryTimeAge(){
		...
		if(   !(   RootPanel.get("ngram").getElement().getInnerText().isEmpty() )      )
		{System.out.println("ngram true");
			x=1;
			ngram= RootPanel.get("ngram").getElement().getInnerText();			
		}
